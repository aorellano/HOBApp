...
class PrivacyController: UIViewController {
    ...
    let privacyDescription: UITextView = {
        let view = UITextView()
        ...
        view.font = UIFont.productDescriptionFont
    ...
    let returnDescription: UITextView = {
        let view = UITextView()
        view.backgroundColor = UIColor(red: 50/255, green: 50/255,blue: 50/255, alpha: 1.0)
        view.text = """
        ...
        let personalInfoTitleLabel: UILabel = {
            let label = UILabel()
            label.text = """
        ...
        let personalInfoDescription: UITextView = {
            let view = UITextView()
            view.backgroundColor = UIColor(red: 50/255, green: 50/255,blue: 50/255, alpha: 1.0)
            view.text = """
            ...
            let protectDescription: UITextView = {
                let view = UITextView()
                view.backgroundColor = UIColor(red: 50/255, green: 50/255,blue: 50/255, alpha: 1.0)
    ...
    override func viewDidLoad() {
        ...
        setupPersonalInfoTitleLabel()
        setupPersonalInfoDescription()
        setupProtectTitleLabel()
        setupProtectDescription()
    }
    
    func setupShippingTitleLabel() {
        view.addSubview(privacyTitleLabel)
        privacyTitleLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 20).isActive = true
        privacyTitleLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20).isActive = true
    }
    
    func setupShippingDescription() {
        view.addSubview(privacyDescription)
        privacyDescription.topAnchor.constraint(equalTo: privacyTitleLabel.bottomAnchor, constant: 10).isActive = true
        privacyDescription.leadingAnchor.constraint(equalTo: view.leadingAnchor).isActive = true
        privacyDescription.trailingAnchor.constraint(equalTo: view.trailingAnchor).isActive = true
        privacyDescription.heightAnchor.constraint(equalToConstant: 120).isActive = true
    }
    func setupReturnTitleLabel() {
        view.addSubview(returnTitleLabel)
        returnTitleLabel.topAnchor.constraint(equalTo: privacyDescription.bottomAnchor, constant: 20).isActive = true
    ...
    func setupReturnDescription() {
        ...
        returnDescription.topAnchor.constraint(equalTo: returnTitleLabel.bottomAnchor, constant: 10).isActive = true
        returnDescription.leadingAnchor.constraint(equalTo: view.leadingAnchor).isActive = true
        returnDescription.trailingAnchor.constraint(equalTo: view.trailingAnchor).isActive = true
        returnDescription.heightAnchor.constraint(equalToConstant: 120).isActive = true
    }
    
    func setupPersonalInfoTitleLabel() {
        view.addSubview(personalInfoTitleLabel)
        personalInfoTitleLabel.topAnchor.constraint(equalTo: returnDescription.bottomAnchor, constant: 20).isActive = true
        personalInfoTitleLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20).isActive = true
    }
    func setupPersonalInfoDescription() {
        view.addSubview(personalInfoDescription)
        personalInfoDescription.topAnchor.constraint(equalTo:personalInfoTitleLabel.bottomAnchor, constant: 10).isActive = true
        personalInfoDescription.leadingAnchor.constraint(equalTo: view.leadingAnchor).isActive = true
        personalInfoDescription.trailingAnchor.constraint(equalTo: view.trailingAnchor).isActive = true
        personalInfoDescription.heightAnchor.constraint(equalToConstant: 120).isActive = true
    }
    
    func setupProtectTitleLabel() {
        view.addSubview(protectTitleLabel)
        
        protectTitleLabel.topAnchor.constraint(equalTo: personalInfoDescription.bottomAnchor, constant: 20).isActive = true
        protectTitleLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20).isActive = true
       
        
    }
    func setupProtectDescription() {
        view.addSubview(protectDescription)
        protectDescription.topAnchor.constraint(equalTo: protectTitleLabel.bottomAnchor, constant: 10).isActive = true
        protectDescription.leadingAnchor.constraint(equalTo: view.leadingAnchor).isActive = true
        protectDescription.trailingAnchor.constraint(equalTo: view.trailingAnchor).isActive = true
        protectDescription.heightAnchor.constraint(equalToConstant: 115).isActive = true
    }
